...
require_once("include/listado_de_chequeo_motivo_devolucion_datachild_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Listado de Chequeo Motivo devolucion DataChild" );
