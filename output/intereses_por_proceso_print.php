...
require_once("include/intereses_por_proceso_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Intereses por Proceso" );
