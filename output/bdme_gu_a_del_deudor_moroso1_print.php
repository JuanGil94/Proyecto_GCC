...
require_once("include/bdme_gu_a_del_deudor_moroso1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Guía del Deudor Moroso" );
