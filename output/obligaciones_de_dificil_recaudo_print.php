...
require_once("include/obligaciones_de_dificil_recaudo_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Obligaciones de Dificil Recaudo" );
