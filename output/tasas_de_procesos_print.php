...
require_once("include/tasas_de_procesos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.Tasas de Procesos" );
