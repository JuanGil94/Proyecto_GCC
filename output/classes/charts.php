...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("dbo.Entidades" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Especialidades" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Estados" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Etapas" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Festivos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.MotivosDevoluciones" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.Oficios" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Operaciones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Parejas" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Presupuestos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Reportes" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Salarios" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.ChequeosOficios" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.ChequeosSancionados" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Devoluciones" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.Pagos1" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Cuentas" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Intereses" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Reasignaciones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Suspensiones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Suspensiones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Interrupciones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Reliquidaciones" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Ayudas" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.Despachos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Remanentes" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Procesos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Prescritos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Procesos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Procesos" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.BusquedasPropiedades" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.Propiedades" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.tipoTasas" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
		...
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Novedades" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Procesos" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.CorrespondenciaMasiva" == $this->chrt_array['tables'][0])
			return true;
		...
		if("dbo.ProcesosView1" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.tiposNovedades" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Procesos" == $this->chrt_array['tables'][0])
		...
		if("dbo.LiquidacionesHistorico" == $this->chrt_array['tables'][0])
			return true;
		if("dbo.Nomenclaturas" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
