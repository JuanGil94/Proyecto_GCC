    ...
    public function process(){
        switch ($this->actuacionId) {
            case "4":
                    ...
                    $resultado["response"]=DB::Exec("UPDATE Procesos set Observaciones='".$this->observaciones."',Intereses=".$this->intereses.",InteresesInicial=".$this->intereses.",Liquidacion='".$this->fechaLiqui.", Persuasivo='".$this->fechaLiqui."',ActuacionId=".$this->actuacionId." where ProcesoId=".$this->procesoId);
