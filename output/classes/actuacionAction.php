...
class coreOficios {
    public $actuacionId,$procesoId,$intereses,$fechaLiqui,$fechaAct,$fecha,$resolucion,$radicado,$observaciones,$oficioId;
    public function __construct($actuacionId,$procesoId,$fecha,$resolucion,$radicado,$observaciones){
    ...
    public function process(){
        switch ($this->actuacionId) {
            case "4":
                    ...
                    $resultado["response"]=DB::Exec("UPDATE Procesos set Intereses=".$this->intereses.",InteresesInicial=".$this->intereses.",Liquidacion='".$this->fechaLiqui."',SeleccionadoFecha=".$this->fechaLiqui.", Persuasivo='".$this->fechaLiqui."',ActuacionId=".$this->actuacionId." where ProcesoId=".$this->procesoId);
