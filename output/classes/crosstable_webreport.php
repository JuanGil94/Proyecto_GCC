...
class CrossTableWebReport
{
	...
	{			
		$isDB = false;
		if("dbo.UsuGCC-ugrights" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.UsuGCC-ugmembers" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.UsuGCC-_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.UsuGCC-_users" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Abogados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Actuaciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Ciudades" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Conceptos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Departamentos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Despachos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Empresas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Entidades" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Especialidades" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Estados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Etapas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Festivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.MotivosDevoluciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Naturalezas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Niveles" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Oficios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Operaciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Parejas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Presupuestos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Reportes" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Salarios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Seccionales" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Test" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Uvts" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.CarteraTipos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Chequeos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.ChequeosOficios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.ChequeosSancionados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Devoluciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Horarios" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("dbo.Acuerdos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Pagos1" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Cuentas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Intereses" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Reasignaciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Suspensiones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Suspensiones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Interrupciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Reliquidaciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Ayudas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Temas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Correspondencias" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.usugcc-_audit" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Importaciones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Indeterminados" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.UserProfile" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Auditorias" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Menus" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Minjusticia" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Minjusticia2" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Minjusticia3" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Actas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.AlertasTipos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Direcciones" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("dbo.Correspondencias" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Bancos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Motivos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Oficios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Tasas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Tasas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Tasas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Carceles" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Alertas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.tipoCobro" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Oficios" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.OperacionTipo" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Ciudades" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Chequeos" == $this->xml_array['tables'][0])
		...
		if("dbo.Procesos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Prescritos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Procesos" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dbo.Procesos" == $this->xml_array['tables'][0])
