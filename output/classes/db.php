	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "GCC_at_S00001_CCAD01" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "InterrupcionesSumaView", "varname" => "GCC_at_S00001_CCAD01_dbo_InterrupcionesSumaView", "altvarname" => "InterrupcionesSumaView", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
