	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "GCC_at_S00001_CCAD01" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "AlertasOficios", "varname" => "GCC_at_S00001_CCAD01_dbo_AlertasOficios", "altvarname" => "AlertasOficios", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Aplazamientos", "varname" => "GCC_at_S00001_CCAD01_dbo_Aplazamientos", "altvarname" => "Aplazamientos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "AuditoriasProcesosView", "varname" => "GCC_at_S00001_CCAD01_dbo_AuditoriasProcesosView", "altvarname" => "AuditoriasProcesosView", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Busquedas", "varname" => "GCC_at_S00001_CCAD01_dbo_Busquedas", "altvarname" => "Busquedas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "BusquedasPropiedades", "varname" => "GCC_at_S00001_CCAD01_dbo_BusquedasPropiedades", "altvarname" => "BusquedasPropiedades", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "codificadoresDespacho", "varname" => "GCC_at_S00001_CCAD01_dbo_codificadoresDespacho", "altvarname" => "codificadoresDespacho", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "CorporacionesView", "varname" => "GCC_at_S00001_CCAD01_dbo_CorporacionesView", "altvarname" => "CorporacionesView", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "CorrespondenciaMasiva", "varname" => "GCC_at_S00001_CCAD01_dbo_CorrespondenciaMasiva", "altvarname" => "CorrespondenciaMasiva", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "despachosSigob", "varname" => "GCC_at_S00001_CCAD01_dbo_despachosSigob", "altvarname" => "despachosSigob", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Fechas", "varname" => "GCC_at_S00001_CCAD01_dbo_Fechas", "altvarname" => "Fechas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Genero", "varname" => "GCC_at_S00001_CCAD01_dbo_Genero", "altvarname" => "Genero", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Nomenclaturas", "varname" => "GCC_at_S00001_CCAD01_dbo_Nomenclaturas", "altvarname" => "Nomenclaturas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "Novedades", "varname" => "GCC_at_S00001_CCAD01_dbo_Novedades", "altvarname" => "Novedades", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "ProcesosView1", "varname" => "GCC_at_S00001_CCAD01_dbo_ProcesosView1", "altvarname" => "ProcesosView1", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "tipoRecaudo", "varname" => "GCC_at_S00001_CCAD01_dbo_tipoRecaudo", "altvarname" => "tipoRecaudo", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "tiposNovedades", "varname" => "GCC_at_S00001_CCAD01_dbo_tiposNovedades", "altvarname" => "tiposNovedades", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "tipoTasas", "varname" => "GCC_at_S00001_CCAD01_dbo_tipoTasas", "altvarname" => "tipoTasas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "UsuariosCarteraTipos", "varname" => "GCC_at_S00001_CCAD01_dbo_UsuariosCarteraTipos", "altvarname" => "UsuariosCarteraTipos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "UsuariosSeccionales", "varname" => "GCC_at_S00001_CCAD01_dbo_UsuariosSeccionales", "altvarname" => "UsuariosSeccionales", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "Uvbs", "varname" => "GCC_at_S00001_CCAD01_dbo_Uvbs", "altvarname" => "Uvbs", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			...
			$dalTables[$conn->connId][] = array("name" => "webpages_Roles", "varname" => "GCC_at_S00001_CCAD01_dbo_webpages_Roles", "altvarname" => "webpages_Roles", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
			$dalTables[$conn->connId][] = array("name" => "webpages_UsersInRoles", "varname" => "GCC_at_S00001_CCAD01_dbo_webpages_UsersInRoles", "altvarname" => "webpages_UsersInRoles", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		}
	}
