...
require_once("include/bdme_reporte_semestral_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Reporte Semestral" );
