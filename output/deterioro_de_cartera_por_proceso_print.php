...
require_once("include/deterioro_de_cartera_por_proceso_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Deterioro de Cartera por Proceso" );
