...
require_once("include/certificado_del_resumen_por_periodo_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Certificado del Resumen por Periodo" );
