...
require_once("include/bdme_cancelaci_n_acuerdo_de_pago_datachild_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Cancelación Acuerdo de Pago DataChild" );
