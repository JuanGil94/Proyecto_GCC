...
require_once("include/persuasivosautomaticos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "PersuasivosAutomaticos" );
