...
require_once("include/tableros_recaudoseccional_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Tableros_RecaudoSeccional" );
