<?php
$topsbdme_excluidos_datachild = array();
		$topsbdme_excluidos_datachild["selectList"] = array(
		"subtype" => "sql",
		"sql" => "SELECT 
    ...
    WHERE ([Extent1].[SancionadoId] = ':session.SancionadoIdDataExcluidos')
"
	);
		$tables_data["BDME Excluidos DataChild"][".operations"] = &$topsbdme_excluidos_datachild;
?>