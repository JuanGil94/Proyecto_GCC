...
/*
$value='<a href="http://localhost:8086/procesos_list.php?qs='.$numero.'~Numero&f=all" onclick="openInNewTab('.$numero.')">'.$numero.'</a>';
echo "<script>
...
;
		return $value;
				...
				if($table=="Presunción Prescripción" && $field=="Numero")
	{
		$numero = $value;
$beforePath = $_SESSION['BeforePath'];
...
;
				...
				if($table=="Obligaciones de Dificil Recaudo" && $field=="Numero" && $ptype=="export")
	{
		...
		return $value;
				...
				if($table=="Privados de la Libertad" && $field=="Proceso")
	{
		$numero = $value;
$beforePath = $_SESSION['BeforePath'];
...
;
		return $value;
				...
				if($table=="Remanentes-" && $field=="Numero")
	{
		$numero = $value;
$beforePath = $_SESSION['BeforePath'];
...
;
		return $value;
				...
				if($table=="Remanentes-" && $field=="ProcesoOrigen")
	{
		$numero = $value;
$beforePath = $_SESSION['BeforePath'];
