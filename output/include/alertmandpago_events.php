 ...
 */
 ...
 class eventclass_alertmandpago  extends eventsBase
{
...
function BeforeQueryList(&$strSQL, &$strWhereClause, &$strOrderBy, $pageObject)
{
		...
		//$strWhereClause = whereAdd($strWhereClause, "P.CarteraTipoId in (".$_SESSION["CarteraTipoId"].") and P.AbogadoId=".$_SESSION["AbogadoId"]."");
