...
$tdatatasas_tes__deterioro_de_cartera_[".orderindexes"] = array();
	$tdatatasas_tes__deterioro_de_cartera_[".orderindexes"][] = array(1, (0 ? "ASC" : "DESC"), "TasaId");



$tdatatasas_tes__deterioro_de_cartera_[".sqlHead"] = "  SELECT TasaId,  Desde AS [Fecha de inicio],  Hasta,  Tasa,  IIF(Tasas.Tipo=1, 'Tasas Tributarias', IIF(Tasas.Tipo=2,'Tasas TES (Deterioro de Cartera)',  	IIF (Tasas.Tipo=3,'Tasas Comerciales',NULL))) AS [Tipo de Tasas]";
...
$proto10["m_sql"] = "Hasta";
$proto10["m_srcTableName"] = "Tasas TES (Deterioro de Cartera)";
$proto10["m_expr"]=$obj;
$proto10["m_alias"] = "";
...
$proto20["m_srcTableName"] = "Tasas TES (Deterioro de Cartera)";
...
$proto19["m_alias"] = "";
$proto19["m_srcTableName"] = "Tasas TES (Deterioro de Cartera)";
$proto21=array();
$proto21["m_sql"] = "";
...
$tdatatasas_tes__deterioro_de_cartera_[".hasEvents"] = false;
