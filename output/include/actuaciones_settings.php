...
$tdataactuaciones[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
$tdataactuaciones[".originalPagesByType"] = $tdataactuaciones[".pagesByType"];
$tdataactuaciones[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdataactuaciones[".originalPages"] = $tdataactuaciones[".pages"];
$tdataactuaciones[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$tdataactuaciones[".scrollGridBody"] = true;
...
$tdataactuaciones[".isDisplayLoading"] = true;
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "dbo.Estados1";
...
//Filters settings
	$fdata["filterTotals"] = 0;
		$fdata["filterMultiSelect"] = 0;
		$fdata["filterTotalFields"] = "ActuacionId";
		$fdata["filterFormat"] = "Values list";
		$fdata["showCollapsed"] = false;
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "dbo.Motivos1";
			$edata["autoCompleteFieldsOnEdit"] = 1;
	$edata["autoCompleteFields"] = array();
		$edata["LCType"] = 0;
...
$masterTablesData["dbo.Actuaciones"] = array();
	...
	//if !@t.bReportCrossTab
			$strOriginalDetailsTable="dbo.Etapas";
	$masterParams = array();
	$masterParams["mDataSourceTable"]="dbo.Etapas1";
	$masterParams["mOriginalTable"]= $strOriginalDetailsTable;
	$masterParams["mShortTable"]= "etapas1";
	$masterParams["masterKeys"]= array();
	$masterParams["detailKeys"]= array();

	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["dbo.Actuaciones"][1] = $masterParams;
				$masterTablesData["dbo.Actuaciones"][1]["masterKeys"] = array();
	$masterTablesData["dbo.Actuaciones"][1]["masterKeys"][]="EtapaId";
				$masterTablesData["dbo.Actuaciones"][1]["detailKeys"] = array();
	$masterTablesData["dbo.Actuaciones"][1]["detailKeys"][]="EtapaId";
