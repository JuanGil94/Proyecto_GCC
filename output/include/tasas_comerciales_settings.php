...
$tdatatasas_comerciales[".sqlHead"] = "SELECT TasaId,  FORMAT(CONVERT(DATE, Desde), 'dd/MM/yyyy') AS [Fecha de inicio],  Hasta,  Tasa,  IIF(Tasas.Tipo=1, 'Tasas Tributarias', IIF(Tasas.Tipo=2,'Tasas TES (Deterioro de Cartera)',  	IIF (Tasas.Tipo=3,'Tasas Comerciales',NULL))) AS [Tipo de Tasas]";
$tdatatasas_comerciales[".sqlFrom"] = "FROM dbo.Tasas";
$tdatatasas_comerciales[".sqlWhereExpr"] = "(Tipo =3)";
...
$proto16["m_srcTableName"] = "Tasas Comerciales";
$proto16["m_expr"]=$obj;
...
$proto22["m_srcTableName"] = "Tasas Comerciales";
...
$proto21["m_alias"] = "";
$proto21["m_srcTableName"] = "Tasas Comerciales";
$proto23=array();
$proto23["m_sql"] = "";
...
include_once(getabspath("include/tasas_comerciales_events.php"));
$tdatatasas_comerciales[".hasEvents"] = true;
