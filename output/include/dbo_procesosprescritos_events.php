 ...
 */
 ...
 class eventclass_dbo_procesosprescritos  extends eventsBase
{
...
//addNotification( "It's time to check your mail", "Mail check", "glyphicon-envelope", "http://localhost:8086/consultas.php?w3=3", null, null, true );
// Place event code here.
// Use "Add Action" button to add code snippets.
;
