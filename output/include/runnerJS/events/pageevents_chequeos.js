...
return Millones(data.enteros)+" "+data.letrasMonedaSingular+" "+data.letrasCentavos;else
return Millones(data.enteros)+" "+data.letrasMonedaPlural+" "+data.letrasCentavos;}
$("#obligacionLetras").val(NumeroALetras(result["valor"]));if(result["tipo"]==1){$("#cantidadLetras").val(NumeroALetras(result["valor"]));}
else if(result["tipo"]==2){$("#cantidadLetras").val(NumeroALetrasSalarios(result["upper"]));}
