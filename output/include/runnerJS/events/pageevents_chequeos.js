...
var ret,reqParams,ctrl=this,fieldsData={},params={},ajax=new Runner.form.Button({id:'Tipo_event',btnName:'Tipo_event'}),before=function(){params["value"]=this.getValue();params["valorAnno"]=$("#yearvalue_FechaSancion_86").val();params["cantidad"]=$("#value_Cantidad_86").val();},after=function(result){function Unidades(num){switch(num)
...
var ret,reqParams,ctrl=this,fieldsData={},params={},ajax=new Runner.form.Button({id:'Tipo_event1',btnName:'Tipo_event1'}),before=function(){params["cantidad"]=this.getValue();params["valorAnno"]=$("#yearvalue_FechaSancion_86").val();params["tipo"]=$("#value_Tipo_86").val();},after=function(result){function Unidades(num){switch(num)
{case 1:return"UN";case 2:return"DOS";case 3:return"TRES";case 4:return"CUATRO";case 5:return"CINCO";case 6:return"SEIS";case 7:return"SIETE";case 8:return"OCHO";case 9:return"NUEVE";}
return"";}
function Decenas(num){decena=Math.floor(num/10);unidad=num-(decena*10);switch(decena)
{case 1:switch(unidad)
...
return Millones(data.enteros)+" "+data.letrasMonedaSingular+" "+data.letrasCentavos;else
return Millones(data.enteros)+" "+data.letrasMonedaPlural+" "+data.letrasCentavos;}
$("#value_ObligacionLetras_86").val(NumeroALetras(result["valor"]));$("#value_Obligacion_86").val(result["valor"]);if(result["tipo"]==1){$("#value_CantidadLetras_86").val(NumeroALetras(result["valor"]));}
else if(result["tipo"]==2){$("#value_CantidadLetras_86").val(NumeroALetrasSalarios(result["upper"]));}
