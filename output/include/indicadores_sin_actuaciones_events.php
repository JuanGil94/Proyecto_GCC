 ...
 */
 ...
 class eventclass_indicadores_sin_actuaciones  extends eventsBase
{
...
function BeforeProcessList($pageObject)
{
		 ...
		 $indicadores_sin_hasta = 	$_SESSION['indicadores_sin_actuacion_mes'];// Fecha en formato YYYY-MM-DD

		 // Separar la fecha en año, mes y día

		// Crear un objeto DateTime a partir del año y mes
		$dateHasta = new DateTime($indicadores_sin_hasta);
		...
		$cartera_nombre = $cartera[$ejecutivo_cartera ];
  		...
  		$sql = "	
    DECLARE  @Hasta DATE = '$indicadores_sin_hasta';
     ...
     WITH a
          ...
          (
              ...
              WHERE(Correspondencias.Fecha <= @Hasta)
    ...
    $resultado = CustomQuery($sql);
	  ...
	  $htmlTable .= 'Indicadores de procesos sin actuaciones a '.$ultimo_dia.'<br>';
		...
		$htmlTable .= '<th style="text-align: center; width: 10%;">Procesos activos Sin Actuaciones</th>';
		$htmlTable .= '<th style="text-align: center; width: 10%;">Indicador</th>';
		$htmlTable .= '<th style="text-align: center; width: 10%;">Procesos activos</th>';
		$htmlTable .= '<th style="text-align: center; width: 10%;">Procesos activos Sin Actuaciones</th>';
		$htmlTable .= '<th style="text-align: center; width: 10%;">Indicador</th>';		
		$htmlTable .= '<th style="text-align: center; width: 10%;">Procesos activos</th>';
