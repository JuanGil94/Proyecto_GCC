<?php
$topstablero_de_control_total_procesos = array();
		$topstablero_de_control_total_procesos["insert"] = array(
		"subtype" => "sql",
...
(
				...
				$topstablero_de_control_total_procesos["selectList"] = array(
		"subtype" => "sql",
...
(
    ...
    WHERE(CarteraTipoId = @CarteraTipoId)
     ...
     WITH a
		...
		$tables_data["Tablero de Control Total Procesos"][".operations"] = &$topstablero_de_control_total_procesos;
?>