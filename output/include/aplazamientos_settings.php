...
$tdataaplazamientos[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
$tdataaplazamientos[".originalPagesByType"] = $tdataaplazamientos[".pagesByType"];
$tdataaplazamientos[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdataaplazamientos[".originalPages"] = $tdataaplazamientos[".pages"];
$tdataaplazamientos[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\"}" );
...
$tdataaplazamientos[".badgeColor"] = "3CB371";
...
$tdataaplazamientos[".googleLikeFields"][] = "AplazamientoId";
$tdataaplazamientos[".googleLikeFields"][] = "AlertaId";
