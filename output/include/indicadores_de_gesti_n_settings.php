...
$tdataindicadores_de_gesti_n[".pageSize"] = 5000;
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "Indicadores de Gestión";
			$edata["autoCompleteFieldsOnEdit"] = 0;
	$edata["autoCompleteFields"] = array();
		$edata["LCType"] = 1;
	...
	$edata["LinkField"] = "Juzgados";
	$edata["LinkFieldType"] = 0;
	$edata["DisplayField"] = "Juzgados";

	

	
	$edata["LookupOrderBy"] = "Juzgados";
...
include_once(getabspath("include/indicadores_de_gesti_n_events.php"));
$tdataindicadores_de_gesti_n[".hasEvents"] = true;
