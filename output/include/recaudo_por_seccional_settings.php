...
$tdatarecaudo_por_seccional[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
$tdatarecaudo_por_seccional[".originalPagesByType"] = $tdatarecaudo_por_seccional[".pagesByType"];
$tdatarecaudo_por_seccional[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
$tdatarecaudo_por_seccional[".originalPages"] = $tdatarecaudo_por_seccional[".pages"];
$tdatarecaudo_por_seccional[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\"}" );
...
$tdatarecaudo_por_seccional[".badgeColor"] = "1E90FF";
