<?php
$topsbdme_incumplimiento_acuerdo_de_pago_semestral_datachild = array();
		$topsbdme_incumplimiento_acuerdo_de_pago_semestral_datachild["selectList"] = array(
		"subtype" => "sql",
		"sql" => "SELECT 
    ...
    WHERE ([Extent1].[SancionadoId] = ':session.SancionadoIdDataIncumplimientos')"
	);
		$tables_data["BDME Incumplimiento Acuerdo de Pago Semestral DataChild"][".operations"] = &$topsbdme_incumplimiento_acuerdo_de_pago_semestral_datachild;
?>