<?php
$topstableros_recaudoseccional = array();
		$topstableros_recaudoseccional["insert"] = array(
		"subtype" => "sql",
...
(
				...
				$topstableros_recaudoseccional["selectList"] = array(
		"subtype" => "sql",
...
(
    ...
    WHERE(CarteraTipoId = @CarteraTipoId)
     ...
     WITH a
		...
		$tables_data["Tableros_RecaudoSeccional"][".operations"] = &$topstableros_recaudoseccional;
?>