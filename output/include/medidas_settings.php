...
// Begin Lookup settings
	...
	$edata["DisplayField"] = "Propiedad";
				...
				$edata["LookupWhere"] = "SancionadoId=:session.SancionadoId or SancionadoId=:session.SancionadosSoli";
...
$masterTablesData["dbo.Medidas"] = array();
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["dbo.Medidas"][2] = $masterParams;
				$masterTablesData["dbo.Medidas"][2]["masterKeys"] = array();
	$masterTablesData["dbo.Medidas"][2]["masterKeys"][]="ProcesoId";
				$masterTablesData["dbo.Medidas"][2]["detailKeys"] = array();
	$masterTablesData["dbo.Medidas"][2]["detailKeys"][]="ProcesoId";
	...
	$masterParams["type"] = PAGE_LIST;
					$masterTablesData["dbo.Medidas"][3] = $masterParams;
				$masterTablesData["dbo.Medidas"][3]["masterKeys"] = array();
	$masterTablesData["dbo.Medidas"][3]["masterKeys"][]="ProcesoId";
				$masterTablesData["dbo.Medidas"][3]["detailKeys"] = array();
	$masterTablesData["dbo.Medidas"][3]["detailKeys"][]="ProcesoId";
