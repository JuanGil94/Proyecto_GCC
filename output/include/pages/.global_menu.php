...
'linkUrl' => '',
'linkTable' => 'dbo.UsuariosSeccionales',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.UsuariosSeccionales',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'hand-right' ),
'linkComments' => array( 'text' => 'Usuarios Seccionales description',
'type' => 0 ),
'background' => '#6B8E23',
'linkType' => 0 ),
'welcome_item2' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.UsuariosCarteraTipos',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.UsuariosCarteraTipos',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'shopping-cart' ),
'linkComments' => array( 'text' => 'Usuarios Cartera Tipos description',
'type' => 0 ),
'background' => '#CD5C5C',
'linkType' => 0 ),
'welcome_item3' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.webpages_Roles',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.webpages_Roles',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'calendar' ),
'linkComments' => array( 'text' => 'Webpages Roles description',
'type' => 0 ),
'background' => '#008B8B',
'linkType' => 0 ),
'welcome_item4' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.webpages_UsersInRoles',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.webpages_UsersInRoles',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'leaf' ),
'linkComments' => array( 'text' => 'Webpages UsersInRoles description',
'type' => 0 ),
'background' => '#DC143C',
'linkType' => 0 ),
'welcome_item5' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.UsuGCC-ugmembers',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.UsuGCC-ugmembers',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'calendar' ),
'background' => '#BC8F8F',
'linkType' => 0 ) ),
