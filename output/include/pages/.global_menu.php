...
'linkUrl' => '',
'linkTable' => 'dbo.Carceles',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Carceles',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'earphone' ),
'linkComments' => array( 'text' => 'Carceles description',
'type' => 0 ),
'background' => '#1E90FF',
'linkType' => 0 ),
'welcome_item1' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.Carceles1',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Carceles1',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'leaf' ),
'linkComments' => array( 'text' => 'Carceles1 description',
'type' => 0 ),
'background' => '#00C2C5',
'linkType' => 0 ),
'welcome_item2' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.Carceles2',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Carceles2',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'calendar' ),
'linkComments' => array( 'text' => 'Carceles2 description',
'type' => 0 ),
'background' => '#3CB371',
'linkType' => 0 ),
'welcome_item3' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.Carceles3',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Carceles3',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'hand-right' ),
'linkComments' => array( 'text' => 'Carceles3 description',
'type' => 0 ),
'background' => '#6B8E23',
'linkType' => 0 ),
'welcome_item4' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.Carceles4',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Carceles4',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'briefcase' ),
'linkComments' => array( 'text' => 'Carceles4 description',
'type' => 0 ),
'background' => '#6B8E23',
'linkType' => 0 ),
'welcome_item5' => array( 'type' => 'welcome_item',
'linkUrl' => '',
'linkTable' => 'dbo.Alertas',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Alertas',
'type' => 6 ),
...
'linkUrl' => '',
'linkTable' => 'dbo.Oficios1',
'linkPage' => 'list',
'linkText' => array( 'table' => 'dbo.Oficios1',
'type' => 6 ),
'linkIcon' => array( 'glyph' => 'fire' ),
'background' => '#8FBC8B',
'linkType' => 0 ) ),
