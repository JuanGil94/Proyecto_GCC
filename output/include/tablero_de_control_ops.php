<?php
$topstablero_de_control = array();
		$topstablero_de_control["insert"] = array(
		"subtype" => "sql",
...
(
				...
				$topstablero_de_control["selectList"] = array(
		"subtype" => "sql",
...
"
		...
		$tables_data["Tablero de Control"][".operations"] = &$topstablero_de_control;
?>