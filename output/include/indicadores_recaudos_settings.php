...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsindicadores_recaudos["Spanish"]["Seccional"] = "DIRECCION SECCIONAL";
	$fieldToolTipsindicadores_recaudos["Spanish"]["Seccional"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["Seccional"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcInic1"] = "CARTERA CORRIENTE Procesos activos durante este periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcInic1"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcInic1"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcFina1"] = "CARTERA CORRIENTE Procesos con Recaudos durante el periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcFina1"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcFina1"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcIndi1"] = "CARTERA CORRIENTE Indicador de gestión de Recaudos";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcIndi1"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcIndi1"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcInic4"] = "CARTERA MINJUSTICIA Procesos activos durante este periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcInic4"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcInic4"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcFina4"] = "CARTERA MINJUSTICIA Procesos con Recaudos durante el periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcFina4"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcFina4"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcIndi4"] = "CARTERA MINJUSTICIA Indicador de gestión de Recaudos";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcIndi4"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcIndi4"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcInic5"] = "CARTERA EJEMPLARIZANTE Procesos activos durante este periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcInic5"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcInic5"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcFina5"] = "CARTERA EJEMPLARIZANTE Procesos con Recaudos durante el periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcFina5"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcFina5"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcIndi5"] = "CARTERA EJEMPLARIZANTE Indicador de gestión de Recaudos";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcIndi5"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcIndi5"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcInicTota"] = "TOTAL Procesos activos durante este periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcInicTota"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcInicTota"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcFinaTota"] = "TOTAL Procesos con Recaudos durante el periodo";
	$fieldToolTipsindicadores_recaudos["Spanish"]["ProcFinaTota"] = "";
	$placeHoldersindicadores_recaudos["Spanish"]["ProcFinaTota"] = "";
	$fieldLabelsindicadores_recaudos["Spanish"]["ProcIndiTota"] = "TOTAL Procesos activos durante este periodo";
...
$tdataindicadores_recaudos[".isUseAjaxSuggest"] = true;
