...
$tdataautorizaciones[".badgeColor"] = "E07878";
...
$tdataautorizaciones[".sqlHead"] = "SELECT TOP 1000 [ChequeoId]        ,[ConceptoId]        ,[AbogadoId]        ,[Fecha]        ,[DespachoId]        ,[Origen]        ,[Providencia]        ,[Ejecutoria]        ,[PrimeraCopia]        ,[Autentica]        ,[PrestaMeritoEjecutivo]        ,[Clara]        ,[Expresa]        ,[ActualmenteExigible]        ,[CompetenciaDEAJ]        ,[FaltaRequisitos]        ,[FaltaCompetencia]        ,[PorPrescripcion]        ,[SeccionalId]        ,[Folios]        ,[SeccionalIdDestino]        ,[Observaciones]        ,[Procesado]        ,[Tipo]        ,[FechaSancion]        ,[Cantidad]        ,[Obligacion]        ,[Costas]        ,[Remisorio]        ,[CarteraTipoId]        ,[MinJusticia]        ,[Aprobado]        ,[AprobadoPor]        ,[FechaAprobacion]        ,[Plazo]        ,[NaturalezaId]        ,[Sigobius]        ,[Monto]        ,[TramiteId]        ,[Fisico]        ,[Digital]";
$tdataautorizaciones[".sqlFrom"] = "FROM [GCC].[dbo].[Chequeos]";
...
{
$proto0=array();
$proto0["m_strHead"] = "SELECT TOP 1000";
$proto0["m_strFieldList"] = "[ChequeoId]        ,[ConceptoId]        ,[AbogadoId]        ,[Fecha]        ,[DespachoId]        ,[Origen]        ,[Providencia]        ,[Ejecutoria]        ,[PrimeraCopia]        ,[Autentica]        ,[PrestaMeritoEjecutivo]        ,[Clara]        ,[Expresa]        ,[ActualmenteExigible]        ,[CompetenciaDEAJ]        ,[FaltaRequisitos]        ,[FaltaCompetencia]        ,[PorPrescripcion]        ,[SeccionalId]        ,[Folios]        ,[SeccionalIdDestino]        ,[Observaciones]        ,[Procesado]        ,[Tipo]        ,[FechaSancion]        ,[Cantidad]        ,[Obligacion]        ,[Costas]        ,[Remisorio]        ,[CarteraTipoId]        ,[MinJusticia]        ,[Aprobado]        ,[AprobadoPor]        ,[FechaAprobacion]        ,[Plazo]        ,[NaturalezaId]        ,[Sigobius]        ,[Monto]        ,[TramiteId]        ,[Fisico]        ,[Digital]";
$proto0["m_strFrom"] = "FROM [GCC].[dbo].[Chequeos]";
$proto0["m_strWhere"] = "";
$proto0["m_strOrderBy"] = "";
...
$proto0["m_fieldlist"][]=$obj;
						$proto26=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[PrestaMeritoEjecutivo]"
));

$proto26["m_sql"] = "[PrestaMeritoEjecutivo]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto32=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[ActualmenteExigible]"
));

$proto32["m_sql"] = "[ActualmenteExigible]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto34=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[CompetenciaDEAJ]"
));

$proto34["m_sql"] = "[CompetenciaDEAJ]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto36=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[FaltaRequisitos]"
));

$proto36["m_sql"] = "[FaltaRequisitos]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto38=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[FaltaCompetencia]"
));

$proto38["m_sql"] = "[FaltaCompetencia]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto40=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[PorPrescripcion]"
));

$proto40["m_sql"] = "[PorPrescripcion]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto46=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[SeccionalIdDestino]"
));

$proto46["m_sql"] = "[SeccionalIdDestino]";
...
$proto0["m_fieldlist"][]=$obj;
						$proto72=array();
$obj = new SQLNonParsed(array(
	"m_sql" => "[FechaAprobacion]"
));

$proto72["m_sql"] = "[FechaAprobacion]";
