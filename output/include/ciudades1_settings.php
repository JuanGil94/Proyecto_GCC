...
$tdataciudades1[".badgeColor"] = "7B68EE";
...
$tdataciudades1[".sqlHead"] = "SELECT C.CiudadId,        DE.Codigo+C.Codigo+ ' - ' + DE.Departamento+ ' ('+ C.Ciudad + ')' AS 'Ciudad\\Municipio'";
$tdataciudades1[".sqlFrom"] = "FROM Ciudades c  LEFT JOIN Departamentos DE ON DE.DepartamentoId = C.DepartamentoId";
...
$tdataciudades1[".arrGridTabs"] = $arrGridTabs;
...
$proto0["m_strFieldList"] = "C.CiudadId,        DE.Codigo+C.Codigo+ ' - ' + DE.Departamento+ ' ('+ C.Ciudad + ')' AS 'Ciudad\\Municipio'";
$proto0["m_strFrom"] = "FROM Ciudades c  LEFT JOIN Departamentos DE ON DE.DepartamentoId = C.DepartamentoId";
$proto0["m_strWhere"] = "";
$proto0["m_strOrderBy"] = "";
...
$proto8["m_sql"] = "DE.Codigo+C.Codigo+ ' - ' + DE.Departamento+ ' ('+ C.Ciudad + ')'";
...
$proto14["m_table"] = $obj;
$proto14["m_sql"] = "LEFT JOIN Departamentos DE ON DE.DepartamentoId = C.DepartamentoId";
$proto14["m_alias"] = "DE";
$proto14["m_srcTableName"] = "dbo.Ciudades1";
$proto16=array();
$proto16["m_sql"] = "DE.DepartamentoId = c.DepartamentoId";
