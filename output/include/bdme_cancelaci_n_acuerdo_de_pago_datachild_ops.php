<?php
$topsbdme_cancelaci_n_acuerdo_de_pago_datachild = array();
		$topsbdme_cancelaci_n_acuerdo_de_pago_datachild["selectList"] = array(
		"subtype" => "sql",
		"sql" => "SELECT 
    ...
    WHERE ([Extent1].[SancionadoId] = ':session.SancionadoIdDataCancela')"
	);
		$tables_data["BDME Cancelación Acuerdo de Pago DataChild"][".operations"] = &$topsbdme_cancelaci_n_acuerdo_de_pago_datachild;
?>