...
class tDAL
{
	...
	var $tblGCC_at_S00001_CCAD01_dbo_Busquedas;
	var $tblGCC_at_S00001_CCAD01_dbo_BusquedasPropiedades;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_codificadoresDespacho;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_despachosSigob;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_InterrupcionesMaxView;
	var $tblGCC_at_S00001_CCAD01_dbo_IPsRestringidas;
	var $tblGCC_at_S00001_CCAD01_dbo_Liquidaciones;
	var $tblGCC_at_S00001_CCAD01_dbo_LiquidacionesHistorico;
	var $tblGCC_at_S00001_CCAD01_dbo_Llamadas;
	var $tblGCC_at_S00001_CCAD01_dbo_Mandamientos;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_Nomenclaturas;
	var $tblGCC_at_S00001_CCAD01_dbo_Novedades;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_Prescritos;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_UsuariosCarteraTipos;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_Uvbs;
	var $tblGCC_at_S00001_CCAD01_dbo_Uvts;
	var $tblGCC_at_S00001_CCAD01_dbo_webpages_Roles;
	var $tblGCC_at_S00001_CCAD01_dbo_webpages_UsersInRoles;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "Busquedas", "varname" => "GCC_at_S00001_CCAD01_dbo_Busquedas", "altvarname" => "Busquedas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		$this->lstTables[] = array("name" => "BusquedasPropiedades", "varname" => "GCC_at_S00001_CCAD01_dbo_BusquedasPropiedades", "altvarname" => "BusquedasPropiedades", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "codificadoresDespacho", "varname" => "GCC_at_S00001_CCAD01_dbo_codificadoresDespacho", "altvarname" => "codificadoresDespacho", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "despachosSigob", "varname" => "GCC_at_S00001_CCAD01_dbo_despachosSigob", "altvarname" => "despachosSigob", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "InterrupcionesMaxView", "varname" => "GCC_at_S00001_CCAD01_dbo_InterrupcionesMaxView", "altvarname" => "InterrupcionesMaxView", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "LiquidacionesHistorico", "varname" => "GCC_at_S00001_CCAD01_dbo_LiquidacionesHistorico", "altvarname" => "LiquidacionesHistorico", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "Mandamientos", "varname" => "GCC_at_S00001_CCAD01_dbo_Mandamientos", "altvarname" => "Mandamientos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "Nomenclaturas", "varname" => "GCC_at_S00001_CCAD01_dbo_Nomenclaturas", "altvarname" => "Nomenclaturas", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		$this->lstTables[] = array("name" => "Novedades", "varname" => "GCC_at_S00001_CCAD01_dbo_Novedades", "altvarname" => "Novedades", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "Prescritos", "varname" => "GCC_at_S00001_CCAD01_dbo_Prescritos", "altvarname" => "Prescritos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "UsuariosCarteraTipos", "varname" => "GCC_at_S00001_CCAD01_dbo_UsuariosCarteraTipos", "altvarname" => "UsuariosCarteraTipos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "Uvbs", "varname" => "GCC_at_S00001_CCAD01_dbo_Uvbs", "altvarname" => "Uvbs", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "webpages_Roles", "varname" => "GCC_at_S00001_CCAD01_dbo_webpages_Roles", "altvarname" => "webpages_Roles", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		$this->lstTables[] = array("name" => "webpages_UsersInRoles", "varname" => "GCC_at_S00001_CCAD01_dbo_webpages_UsersInRoles", "altvarname" => "webpages_UsersInRoles", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
	}
