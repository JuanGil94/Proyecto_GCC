...
class tDAL
{
	var $tblGCC_at_S00001_CCAD01_dbo__UsuariosActivos;
	...
	var $tblGCC_at_S00001_CCAD01_dbo_TipoSancion;
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "_UsuariosActivos", "varname" => "GCC_at_S00001_CCAD01_dbo__UsuariosActivos", "altvarname" => "_UsuariosActivos", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
		...
		$this->lstTables[] = array("name" => "TipoSancion", "varname" => "GCC_at_S00001_CCAD01_dbo_TipoSancion", "altvarname" => "TipoSancion", "connId" => "GCC_at_S00001_CCAD01", "schema" => "dbo", "connName" => "GCC at 192.168.209.48");
