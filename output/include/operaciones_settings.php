...
$tdataoperaciones[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdataoperaciones[".originalPagesByType"] = $tdataoperaciones[".pagesByType"];
$tdataoperaciones[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdataoperaciones[".originalPages"] = $tdataoperaciones[".pages"];
$tdataoperaciones[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsoperaciones["Spanish"]["ConceptoId"] = "Concepto Id";
	$fieldToolTipsoperaciones["Spanish"]["ConceptoId"] = "";
	$placeHoldersoperaciones["Spanish"]["ConceptoId"] = "";
	$fieldLabelsoperaciones["Spanish"]["ConcCodi"] = "Conc Codi";
