...
require_once("include/prescripciones_autom_tica_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Prescripciones Automática" );
