...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 2;
		$data["connId"] = "GCC_at_S00001_CCAD01";
		$data["connName"] = "GCC at 192.168.209.48";
		$data["connStringType"] = "mssql";
		$data["connectionString"] = "mssql;192.168.209.48;sa;B453C0br0c04ct1v0\$;GCC"; //currently unused

		$this->_connectionsIdByName["GCC at 192.168.209.48"] = "GCC_at_S00001_CCAD01";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "sa";
		$data["ODBCPWD"] = "B453C0br0c04ct1v0\\\$";
		$data["leftWrap"] = "[";
		$data["rightWrap"] = "]";
		...
		$data["connInfo"][0] = "192.168.209.48";
		$data["connInfo"][1] = "sa";
		$data["connInfo"][2] = "B453C0br0c04ct1v0\$";
		$data["connInfo"][3] = "GCC";
		$data["connInfo"][4] = "";
		...
		$connectionsData["GCC_at_S00001_CCAD01"] = $data;
