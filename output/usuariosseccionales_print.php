...
require_once("include/usuariosseccionales_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.UsuariosSeccionales" );
