...
require_once("include/consulta_p_blica_notificaci_n_detalle_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consulta Pública Notificación Detalle" );
