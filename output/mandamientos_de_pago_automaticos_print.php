...
require_once("include/mandamientos_de_pago_automaticos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Mandamientos de pago Automaticos" );
