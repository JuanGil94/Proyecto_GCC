...
require_once("include/consolidado_por_conceptos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consolidado por Conceptos" );
