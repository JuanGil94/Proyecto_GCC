...
require_once("include/tablero_de_control_gesti_n_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Tablero de Control Gestión" );
