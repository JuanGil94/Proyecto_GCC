...
require_once("include/tasas_tes__deterioro_de_cartera__variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Tasas TES (Deterioro de Cartera)" );
