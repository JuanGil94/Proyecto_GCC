...
require_once("include/corporaciones___especialidades_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Corporaciones - Especialidades" );
