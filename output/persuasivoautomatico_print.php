...
require_once("include/persuasivoautomatico_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.PersuasivoAutomatico" );
