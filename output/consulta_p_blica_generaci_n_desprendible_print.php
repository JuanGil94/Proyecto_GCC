...
require_once("include/consulta_p_blica_generaci_n_desprendible_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consulta Pública Generación Desprendible" );
