...
require_once("include/certificado_del_resumen_mensual_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Certificado del Resumen Mensual" );
