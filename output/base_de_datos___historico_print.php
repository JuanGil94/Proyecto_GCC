...
require_once("include/base_de_datos___historico_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Base de Datos - Historico" );
