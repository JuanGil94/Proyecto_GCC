...
require_once("include/reportes_datachild_prescritos_con_resoluci_n_expedida_solidarios_bienes_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Reportes DataChild prescritos con resolución expedida_Solidarios_Bienes" );
