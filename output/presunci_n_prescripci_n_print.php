...
require_once("include/presunci_n_prescripci_n_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Presunción Prescripción" );
