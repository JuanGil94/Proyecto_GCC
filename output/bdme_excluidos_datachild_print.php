...
require_once("include/bdme_excluidos_datachild_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Excluidos DataChild" );
