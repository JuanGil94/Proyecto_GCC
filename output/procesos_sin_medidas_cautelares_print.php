...
require_once("include/procesos_sin_medidas_cautelares_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Procesos Sin Medidas Cautelares" );
