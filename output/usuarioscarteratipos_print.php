...
require_once("include/usuarioscarteratipos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.UsuariosCarteraTipos" );
