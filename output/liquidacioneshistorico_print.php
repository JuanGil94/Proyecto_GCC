...
require_once("include/liquidacioneshistorico_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dbo.LiquidacionesHistorico" );
