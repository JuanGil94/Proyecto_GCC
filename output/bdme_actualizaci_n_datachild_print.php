...
require_once("include/bdme_actualizaci_n_datachild_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Actualización DataChild" );
