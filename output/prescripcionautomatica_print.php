...
require_once("include/prescripcionautomatica_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "PrescripcionAutomatica" );
