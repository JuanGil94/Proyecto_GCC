...
require_once("include/consulta_publica_notificacion_detalle_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Consulta Publica Notificacion Detalle" );
