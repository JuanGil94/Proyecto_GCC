...
require_once("include/bdme_incumplimiento_acuerdo_de_pago_semestral1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "BDME Incumplimiento Acuerdo de Pago Semestral" );
