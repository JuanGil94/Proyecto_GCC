...
require_once("include/gesti_n_medidas_cautelares_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Gestión Medidas Cautelares" );
