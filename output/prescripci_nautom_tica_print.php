...
require_once("include/prescripci_nautom_tica_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "PrescripciónAutomática" );
